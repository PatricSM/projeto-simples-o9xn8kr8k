        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input id="survey-url" value={surveyUrl} readOnly className="flex-1" />
              <Button variant="outline" size="icon" onClick={() => copyToClipboard(surveyUrl)}>
              ...
              {qrCodeUrl && (
                <>
                  <div className="flex justify-center">
                    <img src={qrCodeUrl} alt="QR Code da Pesquisa" className="border rounded-lg" />
                  </div>
