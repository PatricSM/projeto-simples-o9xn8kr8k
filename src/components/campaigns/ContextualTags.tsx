...
export default function ContextualTags({
  ...
  const getTagDescription = (question: Question, type: 'value' | 'text' = 'value') => {
    const descriptions = {
      nps_scale:
        type === 'value' ? 'Nota do NPS (0-10)' : 'Classificação (Detrator/Neutro/Promotor)',
        ...
        <Card className="border-0 shadow-none">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded">
              💡 <strong>Como usar:</strong> Clique em uma tag para copiá-la e inseri-la no título
              ou descrição da pergunta. Exemplo: "Baseado na sua nota VALUE_Q1, o que podemos
              melhorar?"
            </div>
          </CardContent>
        </Card>
